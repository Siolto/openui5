...
sap.ui.define(
	["sap/ui/base/Object", "sap/ui/testrecorder/interaction/Commands"],
	function (BaseObject, Commands) {
		 ...
		 */
		var POMethodUtil = BaseObject.extend(
		...
		POMethodUtil.prototype.getPOMethod = function (
			...
			if (mSettings && mSettings.formatAsPOMethod) {
				var sSnippet = aSnippets
					.map(function (sSnippet) {
			...
			if (mSettings.multipleSnippets) {
				switch (mSettings.action) {
					...
					case Commands.ENTER_TEXT:
						return "iInteractWithTheControls";
					default:
						return "iAssertTheUIState";
				}
			} else {
				switch (mSettings.action) {
					case Commands.PRESS:
						return "iPressTheControl";
					case Commands.ENTER_TEXT:
						return "iEnterTextInTheControl";
					default:
						return "iAssertTheControlState";
				}
			}
		};
