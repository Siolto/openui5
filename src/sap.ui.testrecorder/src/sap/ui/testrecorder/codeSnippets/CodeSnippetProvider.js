...
sap.ui.define(
    ...
    function (
        BaseObject,
        OPA5ControlSnippetGenerator,
        RawControlSnippetGenerator,
        UIVeri5ControlSnippetGenerator,
        WDI5ControlSnippetGenerator,
        DialectRegistry,
        Dialects
    ) {
        "use strict";
         ...
         */
        var ControlSnippetProvider = BaseObject.extend(
            "sap.ui.testrecorder.codeSnippets.ControlSnippetProvider",
            {
        ...
        ControlSnippetProvider.prototype.getSnippet = function (mData) {
            var oGenerator = ControlSnippetProvider.getGenerator(
                DialectRegistry.getActiveDialect()
            );
        ...
        ControlSnippetProvider.getGenerator = function (sDialect) {
            switch (sDialect) {
                case Dialects.OPA5:
                    return OPA5ControlSnippetGenerator;
                case Dialects.RAW:
                    return RawControlSnippetGenerator;
                case Dialects.UIVERI5:
                    return UIVeri5ControlSnippetGenerator;
                case Dialects.WDI5:
                    return WDI5ControlSnippetGenerator;
                default:
                    return RawControlSnippetGenerator;
            }
        };
